...
23:36:30 Connecting to https://api.github.com with no credentials, anonymous access
Obtained Jenkinsfile from 87403151f2920be2be36d34281494c5132155c54
[Pipeline] Start of Pipeline
[Pipeline] node
Running on agentVM1 in /home/jenkins/workspace/nt_VasiliyPohomii_week2_vpohomii
[Pipeline] {
[Pipeline] stage
...
Checking out Revision 87403151f2920be2be36d34281494c5132155c54 (week2_vpohomii)
Commit message: "Create Jenkinsfile"
 > git rev-parse --resolve-git-dir /home/jenkins/workspace/nt_VasiliyPohomii_week2_vpohomii/.git # timeout=10
 > git config remote.origin.url https://github.com/vpohomii/material-design-template.git # timeout=10
 > git rev-parse --verify HEAD # timeout=10
Resetting working tree
 > git reset --hard # timeout=10
 > git clean -ffdx # timeout=10
Fetching upstream changes from https://github.com/vpohomii/material-design-template.git
 > git --version # timeout=10
 > git --version # 'git version 2.25.1'
 > git fetch --no-tags --force --progress --prune -- https://github.com/vpohomii/material-design-template.git +refs/heads/week2_vpohomii:refs/remotes/origin/week2_vpohomii # timeout=10
 > git config core.sparsecheckout # timeout=10
 > git checkout -f 87403151f2920be2be36d34281494c5132155c54 # timeout=10
 > git rev-list --no-walk 87403151f2920be2be36d34281494c5132155c54 # timeout=10
[Pipeline] }
[Pipeline] // stage
[Pipeline] withEnv
[Pipeline] {
...
[Pipeline] // stage
[Pipeline] stage
[Pipeline] { (Working with NodeJS npm packages)
[Pipeline] parallel
...
[Pipeline] {
[Pipeline] sh
+ cleancss --batch --batch-suffix .min www/css/font-awesome.min.css www/css/materialize.css www/css/materialize.min.css www/css/style.css '!www/css/*.min.css' -o www/min/
 > git rev-parse --resolve-git-dir /home/jenkins/workspace/nt_VasiliyPohomii_week2_vpohomii/.git # timeout=10
 > git config remote.origin.url https://github.com/vpohomii/material-design-template.git # timeout=10
 > git rev-parse --verify HEAD # timeout=10
Resetting working tree
...
modernizr'
+ for file in $files
+ uglifyjs www/js/init.js -c -o www/min/init.min.js
+ for file in $files
+ uglifyjs www/js/jquery-2.1.1.min.js -c -o www/min/jquery-2.1.1.min.min.js
[Pipeline] }
[Pipeline] // nodejs
[Pipeline] }
[Pipeline] // withEnv
...
[Pipeline] }
+ for file in $files
+ uglifyjs www/js/materialize.js -c -o www/min/materialize.min.js
+ for file in $files
+ uglifyjs www/js/materialize.min.js -c -o www/min/materialize.min.min.js
+ for file in $files
+ uglifyjs www/js/modernizr.js -c -o www/min/modernizr.min.js
[Pipeline] }
[Pipeline] // nodejs
[Pipeline] }
[Pipeline] // withEnv
...
[Pipeline] // stage
[Pipeline] stage
[Pipeline] { (creating tar archive)
[Pipeline] tool
[Pipeline] envVarsForTool
[Pipeline] withEnv
[Pipeline] {
[Pipeline] sh
+ tar --exclude=.git --exclude=www/js --exclude=www/css -cf result.tar www/
[Pipeline] }
[Pipeline] // withEnv
[Pipeline] }
[Pipeline] // stage
